            ...
            <nav class="bg-gray-50 border-b border-maingreen">
                    ...
                    <div class="flex justify-between 2xl:grid 2xl:grid-cols-3 ">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink
                                    v-if="
                                        $page.props.user.is_freetraveler_admin
                                    "
                                    :href="route('pickups.by.zone')"
                                ...
                                <NavLink
                                    ...
                                    "
                                    :href="
                                        route('localisation.currencies.index')
                                    "
                                    :active="
                                        route().current(
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink
                            v-if="$page.props.user.is_freetraveler_admin"
                            :href="route('localisation.currencies.index')"
                            :active="
                                route().current('localisation.currencies.*')
                            "
                        >
                            Divisas
                        </ResponsiveNavLink>
