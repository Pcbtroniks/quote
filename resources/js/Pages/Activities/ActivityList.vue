                        ...
                        <table class="table-auto w-full">
                            ...
                            >
                                <tr>
                                    ...
                                    <template
                                        v-if="
                                            isFilter(props.filters.type, 'park')
                                        "
                                    >
                                        <th class="p-2 whitespace-nowrap">
                                            <div
                                    ...
                                    <template
                                        v-if="
                                            isFilter(props.filters.type, 'tour')
                                        "
                                    >
                                        <th class="p-2 whitespace-nowrap">
                                            <div
                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                <tr
                                    ...
                                    class="hover:cursor-pointer hover:text-white hover:bg-sky-400 h-10"
                                >
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            >
                                                <img
                                                    ...
                                                    "
                                                    class="w-3 inline mr-1 stroke-sky-500 fill-sky-500 text-sky-500"
