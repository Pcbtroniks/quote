    ...
    <div class="QuotePDF px-[69px] py-[48px]" spellcheck="false">
        ...
        <div class="" spellcheck="false">
            <div>
                <img
                    ...
                    alt="Logo Freetravelers"
                />
            </div>

            <div>
                <table
                    class="border-collapse border w-[517px] text-center"
                    style="width: 517px"
                    border="1"
                >
                    <thead></thead>
                    <tbody>
                        <tr style="height: 30px">
                            <td style="height: 30px" class="border">
                                Cúpon de servicio / service coupon
                            </td>
                        </tr>
                        <tr style="height: 40px">
                            <td style="height: 40px" class="border">
                                {{ quote.coupon?.code }}
                            </td>
                        </tr>
                        <tr style="height: 30px">
                            <td style="height: 30px" class="border">
                                Lugar y fecha / Date and place
                            </td>
                        </tr>
                        <tr style="height: 40px">
                            <td style="height: 40px" class="border">
                    ...
                    >
                        ...
                        >
                            ...
                            <span style="padding-left: 24px">{{
                                quote.type == "tour" &&
                                quote.listed_activity.pickup_time != "00:00:00"
        ...
        <div class="mt-4 flex justify-between">
            ...
            <div>
                <img
                    src="/assets/exploreemotions-logo.png"
                    alt="Logo exploreemotions"
                />
            </div>
            <div style="width: 7rem">
                <img
                    style="width: 100%"
                    src="/assets/sello_vero_45.jpeg"
                    alt="Sello Vero 45"
                />
            </div>
        </div>
