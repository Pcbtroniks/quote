...
<template>
<section class="sm:ml-2 w-full">
    <details class="xl:w-96 lg:w-80 bg-white p-4 rounded-xl shadow-md group mx-auto max-h-[56px] open:!max-h-[400px] transition-[max-height] duration-500 overflow-hidden">
        <summary
