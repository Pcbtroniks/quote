            ...
            <table style="width: 1077; border: solid 1px;">
                <tbody>
                    <tr style="height: 59px; text-align: center;" spellcheck="false">
                        ...
                        <td style="height: 59px; border: 1px solid; width: 301.2px; text-align: left;">Horario /<br>Schedule <span style="padding-left: 24px">{{ quote.type == 'tour' ? quote.listed_activity?.pickup_time : '' }}</span></td>
                    </tr>
