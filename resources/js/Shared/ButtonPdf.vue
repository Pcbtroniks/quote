...
<div class="border-t-2 flex space-x-4 py-4">
    <a :href="route('export.pdf.quote.download', quote.id)">
    <div class="w-70 flex items-center py-2.5 px-2 border-2 border-gray-300 rounded-lg hover:bg-gray-200">
        <div class="flex items-center">
            ...
            <div class="w-48 ml-2 flex flex-col">
                <a href="#" class="text-sm text-gray-700 font-bold truncate">Cotizacion Freetraveler.pdf</a>
                <span class="text-gray-500 text-xs">Descargar</span>
            </div>
        </div>
