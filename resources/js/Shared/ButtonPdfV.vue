...
<div class="border-t-2 flex space-x-4 py-4">
    <a :href="route('export.pdf.quote.view', quote.id)" target="_blank">
        <div class="w-full flex items-center py-3 px-4 border-2 border-green-500 rounded-xl bg-gradient-to-r from-green-100 to-green-300 hover:from-green-200 hover:to-green-400 transition-all duration-200 shadow-lg cursor-pointer">
            <div class="flex items-center">
                ...
                <div class="lg:w-48 w-full ml-4 flex flex-col">
                    <p class="text-base text-green-900 font-bold truncate">Cotización.pdf</p>
                    <span class="text-green-700 text-xs">Haz clic para VER el PDF</span>
                </div>
            </div>
        </div>
    </a>
