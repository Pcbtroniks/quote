...
<div class="border-t-2 flex space-x-4 py-4">
    <a :href="route('export.pdf.quote.view', quote.id)" target="_blank">
        <div class="w-full flex items-center py-3 px-4 border-2 border-blue-500 rounded-xl bg-gradient-to-r from-blue-100 to-blue-300 hover:from-blue-200 hover:to-blue-400 transition-all duration-200 shadow-lg cursor-pointer">
