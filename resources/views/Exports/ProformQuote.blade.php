...
<div style="width: 595px; height: 1000px; position: relative; background: white; border: 1px solid gray; display: flex; justify-content: center; margin: 0 auto">
    ...
    <!-- Fondo del contenido -->
    <div style="width: 500px; height: 540px; left: 53px; top: 220px; position: absolute; background-color: #f8fafc">
    <div style="width: 500px; height: 150px; left: 0px; top: 600px; position: absolute; background-color: #a5c296"></div>
    ...
    <div style="width: 500px; height: 120px; left: 0px; top: 200px; position: absolute">
      ...
      <div style="left: 20px; top: 33px; position: absolute; font-size: 16px; color: black; font-weight: 800">
    ...
    <div style="width: 500px; height: 400px; left: 0px; top: 400px; position: absolute">
    ...
    <div style="width: 500px; height: 150px; left: 0px; top: 600px; position: absolute;">
        <div style="width: 500px; top: 10px; font-size: 16px; font-weight: 700; color: #52763e;position: absolute; text-align: center;">Número de confirmación del proveedor:</div>

        <div style="width: 500px; top: 50px; font-size: 40px; font-weight: 800; color: #52763e; position: absolute; text-align: center;">{{ $quote->public_pric ?? 'En espera de confirmación' }}</div>
    </div>
